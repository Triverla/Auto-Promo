    ...
    <section class="sidebar">
        ...
        <div class="user-panel">
            <div class="pull-left image">
                <img src="/passports/{{ auth()->user()->passport }}"  class="img-circle" alt="User Image">
            </div>
        ...
        <ul class="sidebar-menu">
            <li class="header">APER-FORM</li>
            <li class="treeview @if(request()->segment(2) == 'products') active @endif">
                <a href="#">
                    <i class="fa fa-gift"></i> <span>Academic Staff</span>
                    <span class="pull-right-container">
                            <i class="fa fa-angle-left pull-right"></i>
                    </span>
                </a>
                <ul class="treeview-menu">
                    <li><a href="{{route('apply')}}"><i class="fa fa-circle-o"></i> Apply</a></li>
                    <li><a href="{{route('details')}}"><i class="fa fa-plus"></i> View Details</a></li>
                </ul>
            </li>
            <li class="treeview @if(request()->segment(2) == 'categories') active @endif">
                <a href="#">
                    <i class="fa fa-folder"></i> <span>Junior Staff</span>
                    <span class="pull-right-container">
                            <i class="fa fa-angle-left pull-right"></i>
                    </span>
                </a>
                <ul class="treeview-menu">
                    ...
                    <li><a href=""><i class="fa fa-plus"></i> View Details</a></li>
                </ul>
            </li>

            <li class="header">H.O.D Section</li>
            <li class="treeview">
                <a href="#">
                    <i class="fa fa-money"></i> <span>Promotion Details</span>
                    <span class="pull-right-container">
                            <i class="fa fa-angle-left pull-right"></i>
                    </span>
                </a>
                <ul class="treeview-menu">
                    <li><a href=""><i class="fa fa-circle-o"></i> Scoring System</a></li>
                </ul>
            </li>
